...
class OrdersController extends AbstractController
{
    ...
    public function new(Request $request, ShopcardRepository $shopcardRepository): Response
    {
        ...
        if($this->isCsrfTokenValid('form-order',$submittedToken)) {
            ...
            if ($form->isSubmitted()) {
                ...
                $orderid=$orders->getId(); //en son orders bilgilerini getiriyor
                $shopcart=$shopcardRepository->getUserShopCart($userid);
                ...
                foreach ($shopcart as $item)
                {
                    ...
                    $orderdetail->setPrice($item["saprice"]);
                ...
                //user shopkart ürünlerini siliyor
                $em = $this->getDoctrine()->getManager();
                ...
                $this->addFlash('success','Siparişiniz başarı ile gerçekleşmiştir... Teşekkür Ederiz');
    ...
    /**
     * @Route("home/{id}", name="orders_show", methods="GET")
     */
